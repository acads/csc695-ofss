...
4)	Download a valid NetPDL database.	
	...
	If this does not work (e.g., because you have limited Internet 
	connectivity), please open the web site http://www.nbee.org and download
	the newest protocol database manually.
