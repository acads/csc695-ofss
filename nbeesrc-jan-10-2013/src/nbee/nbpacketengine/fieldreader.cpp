...
{	
	...
	{
		//list<uint32_t> positions = FieldDescriptorsVector->FieldDescriptor[index].Positions;
		//assert(positions.size()!=0 && "Very strange! There should be a BUG!");
		//uint32_t position = FieldDescriptorsVector->FieldDescriptor[index].Positions.front();
		//FieldDescriptorsVector->FieldDescriptor[index].Positions.pop_front();
		//FieldDescriptorsVector->FieldDescriptor[index].Positions.push_back(position);
		...
		{	
			...
			else if(FieldDescriptorsVector->FieldDescriptor[index].FieldType == PDL_FIELD_TYPE_LINE)
			{
				if ((FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIPROTO) || (FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIFIELD))
				{
					int n = *(uint32_t *) &DataInfo[FieldDescriptorsVector->FieldDescriptor[index].Position];
			...
			else if(FieldDescriptorsVector->FieldDescriptor[index].FieldType == PDL_FIELD_TYPE_PATTERN)
			{
				if ((FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIPROTO) || (FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIFIELD))
				{
					int n = *(uint32_t *) &DataInfo[FieldDescriptorsVector->FieldDescriptor[index].Position];
			...
			else if(FieldDescriptorsVector->FieldDescriptor[index].FieldType == PDL_FIELD_TYPE_TOKEND)
			{
				if ((FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIPROTO) || (FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIFIELD))
				{
					int n = *(uint32_t *) &DataInfo[FieldDescriptorsVector->FieldDescriptor[index].Position];
			...
			else if(FieldDescriptorsVector->FieldDescriptor[index].FieldType == PDL_FIELD_TYPE_EATALL)
			{
				if ((FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIPROTO) || (FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIFIELD))
				{
					int n = *(uint32_t *) &DataInfo[FieldDescriptorsVector->FieldDescriptor[index].Position];
			...
			else if(FieldDescriptorsVector->FieldDescriptor[index].FieldType == PDL_FIELD_TYPE_TOKWRAP)
			{
				if ((FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIPROTO) || (FieldDescriptorsVector->FieldDescriptor[index].DataFormatType == nbNETPFLCOMPILER_DATAFORMAT_MULTIFIELD))
				{
					int n = *(uint32_t *) &DataInfo[FieldDescriptorsVector->FieldDescriptor[index].Position];
